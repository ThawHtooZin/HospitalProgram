          ...
          <div class="container" style="margin-top:100px;">
            <table class="table table-stripe table-bordered table-hover">
              ...
              <tr>
                ...
                <td><button type="button" onclick="return confirm('Are you sure to cancel the appointment?') " class="btn btn-warning"><a href="cancelappointment.php?id=<?php echo $data['id']; ?>" style="text-decoration:none; color:white;">Cancel</a></button></td>
                <?php
                }
                ?>
              </tr>
