    ...
    <div class="row" style="margin: 0px !important; margin-left: -12px !important;">
      ...
      <div class="col-9">
        <div class="container mt-5">
          <h3>Admin | Mange Read Message</h3>
          <div class="container" style="margin-top:100px;">
            <table class="table table-stripe table-bordered table-hover">
              ...
              <?php
              $datas = $query->selectreadmessage('contact');
              ...
              <tr>
                ...
                <td>
                  <a href="messageview.php?id=<?php echo $data['id']; ?>&viewpage=read" class="btn btn-primary">View</a>
                </td>
              </tr>
              <?php
            }
