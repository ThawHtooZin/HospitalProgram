<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 25%; height:100%; position:fixed;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        ...
        <div class="collapse" id="doc-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-2 ms-5">
            <li class="p-1 patientmanage"><a href="doctorspecial.php" class="link-light rounded">Doctor Specialization</a></li>
            <li class="p-1 patientmanage"><a href="doctoradd.php" class="link-light rounded">Add Doctor</a></li>
            <li class="p-1 patientmanage"><a href="managedoctor.php" class="link-light rounded">Manage Doctors</a></li>
          </ul>
        </div>
      </li>
      <li>
        <a href="/HospitalProgram/admin/appointmenthistory.php" class="nav-link text-white patient" data-bs-toggle="collapse" data-bs-target="#user-collapse" aria-expanded="true">
          <svg class="bi me-2" width="16" height="16"><i class="bi bi-people"></i></svg>
          Users
        </a>
        <div class="collapse" id="user-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-2 ms-5">
            <li class="p-1 patientmanage"><a href="patientmanage.php" class="link-light rounded">Manage Users</a></li>
          </ul>
        </div>
      </li>
      <li>
      ...
      <li>
        <a href="/HospitalProgram/admin/appointmenthistory.php" class="nav-link text-white appointmenthistory">
          <svg class="bi me-2" width="16" height="16"><i class="bi bi-newspaper"></i></svg>
          Contact Queries
        </a>
      </li>
    </ul>
